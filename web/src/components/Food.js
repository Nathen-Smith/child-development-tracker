  ...
  return (
    ...
    <div className="bg-white flex overflow-hidden">
      ...
      <div class="relative grid grid-cols-1 gap-4 p-4 mb-8 border rounded-lg bg-white shadow-lg">
            ...
            <Form>
            <p class="relative text-lg whitespace-nowrap truncate overflow-hidden mr-12 mb-2" style={{'width': '240px'}}>Type Of Food</p>
    ...
    <p class="relative text-lg whitespace-nowrap truncate overflow-hidden mr-12 mb-2 mt-6" style={{'width': '240px'}}>Time Of Feeding</p>
